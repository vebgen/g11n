...
// TODO general: search all the occurrences of `update` and replace with your command name

// const debug = rootDebug.extend('update')
// const debugError = rootDebug.extend('update:error')
